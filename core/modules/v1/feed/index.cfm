							...
							<cfif variables.feedData.type neq "atom">
								<cfloop from="1" to="#variables.feedData.maxItems#" index="i">
									<li<cfif (i EQ 1)> class="first"<cfelseif (i EQ variables.feedData.maxItems)> class="last"</cfif>>
										...
										<cfif arguments.hasSummary and structKeyExists(variables.feedData.itemArray[i],"description")><p class="summary"><!--- asp trying to hide blog post summary on mobile --->
                                        <span class="d-sm-none d-md-block">#variables.feedData.itemArray[i].description.xmlText#!!!</span></p></cfif>
									</li>
								</cfloop>
							<cfelse>
								<cfloop from="1" to="#variables.feedData.maxItems#" index="i">
						...
						<cfif variables.feedData.type neq "atom">
							<cfloop from="1" to="#variables.feedData.maxItems#" index="i">
								<dl<cfif (i EQ 1)> class="first"<cfelseif (i EQ variables.feedData.maxItems)> class="last"</cfif>>
									...
									<cfif arguments.hasSummary and structKeyExists(variables.feedData.itemArray[i],"description")><dd class="summary">
                                        <!--- asp trying to hide blog post summary on mobile --->
                                        <span class="d-sm-none d-md-block">
                                            #variables.feedData.itemArray[i].description.xmlText#</span>...</dd></cfif>
								</dl>
							</cfloop>
						<cfelse>
							<cfloop from="1" to="#variables.feedData.maxItems#" index="i">
								<dl<cfif (i EQ 1)> class="first"<cfelseif (i EQ variables.feedData.maxItems)> class="last"</cfif>>
									...
									<cfif arguments.hasSummary and structKeyExists(variables.feedData.itemArray[i],"summary")><dd class="summary">
                                        <!--- asp trying to hide blog post summary on mobile --->
                                        <span class="d-sm-none d-md-block">
                                            #variables.feedData.itemArray[i].summary.xmlText#!!
                                        </span>
                                            </dd></cfif>
								</dl>
							</cfloop>
