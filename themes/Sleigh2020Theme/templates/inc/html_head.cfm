...
<head>
	...
	})(window,document,'script','dataLayer','GTM-K94NHQK');</script>
    ...
    <!--- Custom Site Additions CSS Testimonial Slider --->
	<link rel="stylesheet" href="#$.siteConfig('themeAssetPath')#/css/testimonialSlider2.css">
    <link rel="stylesheet" href="#$.siteConfig('themeAssetPath')#/css/imageManipulation.css">
    <link rel="stylesheet" href="#$.siteConfig('themeAssetPath')#/css/homePageAdditions.css">
	<!--- jQuery --->
