<cfoutput>
	...
	<!--- Primary Associated Image --->
        ...
        ASP
        7/3/2020
        Let's see if we cannot get creative here with the non display of images --->
		<cfif $.content().hasImage(usePlaceholder=false) and $.content().getTitle() neq "Make an Appointment">
            <cfif showMetaImage eq true>
			<cfscript>
			...
			<div class="mura-asset my-3"><!-- \content_types\page\index.cfm -->
                ...
                <!---<p>#$.content().hasImage(showMetaImage)#</p>--->
			</div>
            </cfif>
        <cfelse>
<!---          <p>else #$.content().hasImage(showMetaImage)#</p>--->
		</cfif>
	<!--- /Primary Associated Image --->
