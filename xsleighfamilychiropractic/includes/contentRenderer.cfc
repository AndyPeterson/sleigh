...
9.1.2019 - geturlStem is forcing a non ssl redirect. Instead of disabling it, both conditionals now go to the same place. See commented out code on line 81.
--->
